...
const SVC_URL = "https://appadaycreator.com/nail-design-advisor/";
const SVC_NAME = "ネイルデザイン選び診断";

test.describe("ネイルデザイン選び診断 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("nail-design-advisor");
